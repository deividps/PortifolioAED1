...
public class Shooter : MonoBehaviour {
    ...
    public int NumeroDeBalas = 15;
    int municao;
    public float tempoDeCarga = 0.5f;
    public Slider Balas;
    ...
    private void Awake()
    {
        municao = NumeroDeBalas;
        InvokeRepeating("Recarregar", tempoDeCarga, tempoDeCarga);
    }
    void Update () {
        // Detect if fire button is pressed
        Balas.value = municao;
		if (Input.GetButtonDown("Fire1") && enable && (municao>0))
		{	
